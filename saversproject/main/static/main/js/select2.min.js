    ...
    var b = function () {
            ...
            b.define("jquery", [], function () {
                ...
                return null == b && console && console.error && console.error(
                    "Select2: An instance of jQuery or a jQuery-compatible library was not found. M" +
                    "ake sure that you are including jQuery before Select2 on your web page."
                ),
                b
            }),
            ...
            b.define("select2/results", [
                ...
                c.prototype.render = function () {
                    ...
                    return this
                        .options
                        .get("multiple") && b.attr("aria-multiselectable", "true"),
                    this.$results = b,
                    b
                },
                ...
                c.prototype.bind = function (b, c) {
                    ...
                    this
                        .$results
                        .on("mouseup", ".select2-results__option[aria-selected]", function (b) {
                            var c = a(this),
                                e = c.data("data");
                    ...
                    this
                        .$results
                        .on("mouseenter", ".select2-results__option[aria-selected]", function (b) {
                    ...
                    if (0 !== a.length) {
                        ...
                        2 >= c
                            ? this
                                .$results
                                .scrollTop(0)
                            : (g > this.$results.outerHeight() || 0 > g) && this
                                .$results
                                .scrollTop(f)
                    }
                },
            ...
            b.define("select2/selection/base", [
                ...
                d.prototype.render = function () {
                    var b = a(
                        '<span class="select2-selection" role="combobox"  aria-haspopup="true" aria-exp' +
                        'anded="false"></span>'
                    );
                    ...
                    null != this
                        ...
                        .data("old-tabindex")
                            ...
                            : null != this
                                .$element
                                .attr("tabindex") && (this._tabindex = this.$element.attr("tabindex")),
                ...
                d.prototype.bind = function (a, b) {
                    ...
                    a.on("results:focus", function (a) {
                        d
                            .$selection
                            .attr("aria-activedescendant", a.data._resultId)
                    }),
            ...
            b.define("select2/selection/single", [
                ...
                e.prototype.render = function () {
                    ...
                    a.html(
                        '<span class="select2-selection__rendered"></span><span class="select2-selectio' +
                        'n__arrow" role="presentation"><b role="presentation"></b></span>'
                    ),
                    a
                },
            ...
            b.define("select2/selection/multiple", [
                ...
                d.prototype.bind = function (b, c) {
                    ...
                    this
                        .$selection
                        .on("click", ".select2-selection__choice__remove", function (b) {
                ...
                d.prototype.selectionContainer = function () {
                    var b = a(
                        '<li class="select2-selection__choice"><span class="select2-selection__choice__' +
                        'remove" role="presentation">&times;</span></li>'
                    );
                    return b
                },
                d.prototype.update = function (a) {
            ...
            b.define("select2/selection/allowClear", [
                ...
                return c.prototype.bind = function (a, b, c) {
                    var d = this;
                    a.call(this, b, c),
                    null == this.placeholder && this
                        .options
                        .get("debug") && window.console && console.error && console.error(
                        "Select2: The `allowClear` option should be used in combination with the `place" +
                        "holder` option."
                    ),
                    this
                        .$selection
                        .on("mousedown", ".select2-selection__clear", function (a) {
                            d._handleClear(a)
                        }),
            ...
            b.define("select2/selection/search", [
                ...
                return d.prototype.render = function (b) {
                    var c = a(
                        '<li class="select2-search select2-search--inline"><input class="select2-search' +
                        '__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" auto' +
                        'capitalize="off" spellcheck="false" role="textbox" aria-autocomplete="list" />' +
                        '</li>'
                    );
                ...
                d.prototype.bind = function (a, b, d) {
                    ...
                    b.on("results:focus", function (a) {
                        e
                            .$search
                            .attr("aria-activedescendant", a.id)
                    }),
                    this
                        .$selection
                        .on("focusin", ".select2-search--inline", function (a) {
                            e.trigger("focus", a)
                        }),
                    this
                        .$selection
                        .on("focusout", ".select2-search--inline", function (a) {
                            e._handleBlur(a)
                        }),
                    this
                        .$selection
                        .on("keydown", ".select2-search--inline", function (a) {
                            a.stopPropagation(),
                    ...
                    this
                        .$selection
                        .on("input.searchcheck", ".select2-search--inline", function (a) {
                            return g
                                ? void e
                                    .$selection
                    ...
                    this
                        .$selection
                        .on("keyup.search input.search", ".select2-search--inline", function (a) {
                            if (g && "input" === a.type) 
                                return void e
                                    .$selection
                                    .off("input.search input.searchcheck");
                ...
                d.prototype._transferTabIndex = function (a) {
                    this
                        .$search
                        .attr("tabindex", this.$selection.attr("tabindex")),
                    this
                        .$selection
                        .attr("tabindex", "-1")
                },
            ...
            b.define("select2/data/select", [
                ...
                d.prototype._normalizeItem = function (a) {
                    ...
                    null == a._resultId && a.id && null != this.container && (
                ...
                d.prototype.query = function (a, b) {
                    function d() {
                        var d = f.transport(f, function (d) {
                            ...
                            e
                                .options
                                .get("debug") && window.console && console.error && (
                                    f && f.results && c.isArray(f.results) || console.error(
                                    "Select2: The AJAX results did not return an array in the `results` key of the " +
                                    "response."
                                )
                                ),
                            b(f)
                        }, function () {
                            d.status && "0" === d.status || e.trigger(
                                "results:message",
            ...
            b.define("select2/data/tokenizer", ["jquery"], function (a) {
                ...
                return b.prototype.bind = function (a, b, c) {
                    a.call(this, b, c),
                    this.$search = b.dropdown.$search || b.selection.$search || c.find(
            ...
            b.define("select2/dropdown/search", [
                ...
                return c.prototype.render = function (b) {
                    var c = b.call(this),
                        d = a(
                            '<span class="select2-search select2-search--dropdown"><input class="select2-se' +
                            'arch__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" ' +
                            'autocapitalize="off" spellcheck="false" role="textbox" /></span>'
                        );
            ...
            b.define("select2/dropdown/infiniteScroll", ["jquery"], function (a) {
                ...
                b.prototype.createLoadingMore = function () {
                    var b = a(
                            '<li class="select2-results__option select2-results__option--load-more"role="tr' +
                            'eeitem" aria-disabled="true"></li>'
                        ),
                        c = this
                            .options
                            .get("translations")
            ...
            b.define("select2/dropdown/selectOnClose", [], function () {
                ...
                a.prototype._handleSelectOnClose = function (a, b) {
                    ...
                    if (!(d.length < 1)) {
                        var e = d.data("data");
                        null != e.element && e.element.selected || null == e.element && e.selected || this.trigger(
                            "select",
                            {data: e}
                        )
                    }
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    l.debug && window.console && console.warn && console.warn(
                                        'Select2: The language file for "' + M + '" could not be automatically loaded. ' +
                ...
                return e.prototype.fromElement = function (a) {
                    ...
                    a.data("select2Tags") && (
                        this.options.debug && window.console && console.warn && console.warn(
                            'Select2: The `data-select2-tags` attribute has been changed to use the `data-d' +
                            'ata` and `data-tags="true"` attributes and will be removed in future versions ' +
                            'of Select2.'
                        ),
                    ...
                    a.data("ajaxUrl") && (
                        this.options.debug && window.console && console.warn && console.warn(
                            "Select2: The `data-ajax-url` attribute has been changed to `data-ajax--url` an" +
                            "d support for the old attribute will be removed in future versions of Select2."
                        ),
            ...
            b.define("select2/core", [
                ...
                var e = function (a, c) {
                    ...
                    this
                        .results
                        .position(this.$results, this.$dropdown);
                    var k = this;
                    this._bindAdapters(),
                ...
                e.prototype._registerDomEvents = function () {
                    ...
                    this
                        ...
                        .attachEvent && this
                        .$element[0]
                        .attachEvent("onpropertychange", this._syncA);
                ...
                e.prototype._syncAttributes = function () {
                    this
                        .options
                        .set("disabled", this.$element.prop("disabled")),
                    this
                        .options
                        .get("disabled")
                ...
                e.prototype.enable = function (a) {
                    this
                        .options
                        .get("debug") && window.console && console.warn && console.warn(
                        'Select2: The `select2("enable")` method has been deprecated and will be remove' +
                        'd in later Select2 versions. Use $element.prop("disabled") instead.'
                    ),
                ...
                e.prototype.data = function () {
                    this
                        .options
                        .get("debug") && arguments.length > 0 && window.console && console.warn && console.warn(
                        'Select2: Data can no longer be set using `select2("data")`. You should conside' +
                        'r setting the value instead using `$element.val()`.'
                    );
                    var a = [];
                    return this
                        .dataAdapter
                ...
                e.prototype.val = function (b) {
                    if (
                        this.options.get("debug") && window.console && console.warn && console.warn(
                            'Select2: The `select2("val")` method has been deprecated and will be removed i' +
                            'n later Select2 versions. Use $element.val() instead.'
                        ),
                        null == b || 0 === b.length
                    ) 
                        return this
                ...
                e.prototype.destroy = function () {
                    ...
                    this
                        ...
                        .detachEvent && this
                        .$element[0]
                        .detachEvent("onpropertychange", this._syncA),
                    null != this._observer
                    ...
                    this
                        .$element
                        .attr("tabindex", this.$element.data("old-tabindex")),
                    this
                        .$element
                ...
                e.prototype.render = function () {
                    var b = a(
                        '<span class="select2 select2-container"><span class="selection"></span><span c' +
                        'lass="dropdown-wrapper" aria-hidden="true"></span></span>'
                    );
                    return b.attr("dir", this.options.get("dir")),
                    this.$container = b,
                    this
                        .$container
                        .addClass("select2-container--" + this.options.get("theme")),
                        ...
                        if ("string" == typeof b) {
                            ...
                            return this.each(function () {
                                ...
                                null == c && window.console && console.error && console.error(
                                    "The select2('" + b + "') method was called on an element that is not using Sel" +
                                    "ect2."
                                ),
                                d = c[b].apply(c, f)
                            }),
