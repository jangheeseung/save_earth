...
function (a, b) {
        ...
        var t = function (a) {
            var b,
                ...
                K = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap" +
                ...
                W = {
                    ...
                    needsContext: new RegExp(
                        "^" + L + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + L + "*((?:-\\d)?" +
                                "\\d*)" + L + "*\\)|)(?=[^-]|$)",
                        "i"
                    )
                },
            ...
            d = fa.selectors = {
                ...
                filter: {
                    ...
                    PSEUDO: function (a, b) {
                        var c,
                            e = d.pseudos[a] || d.setFilters[a.toLowerCase()] || fa.error(
        ...
        C = n.fn.init = function (a, b, c) {
                ...
                if (c = c || A, "string" == typeof a) {
                    if (
                        e = "<" === a.charAt(0) && ">" === a.charAt(a.length - 1) && a.length >= 3
                            ? [null, a, null]
                            : B.exec(a),
                        !e || !e[1] && b
                    ) 
            ...
            l.shrinkWrapBlocks = function () {
                ...
                c && c.style
                    ? (
                        ...
                        c.appendChild(e).appendChild(b),
                        "undefined" != typeof b.style.zoom && (
                            b.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-" +
        ...
        aa = /^\s+/,
        ba = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|dialog|figcaption|fi" +
                    "gure|footer|header|hgroup|main|mark|meter|nav|output|picture|progress|section|" +
                ...
                if (g = a[r], g || 0 === g) 
                    if ("object" === n.type(g)) 
                        ...
                        if (
                            ...
                            while (f--) 
                                n.nodeName(k = g.childNodes[f], "tbody") && !k.childNodes.length && g.removeChild(
                                    k
                                )
                        }
        ...
        n.event = {
            ...
            trigger: function (b, c, e, f) {
                ...
                if (
                    i = m = e = e || d,
                    3 !== e.nodeType && 8 !== e.nodeType && !na.test(q + n.event.triggered) && (
            ...
            props: (
                "altKey bubbles cancelable ctrlKey currentTarget detail eventPhase metaKey rela" +
                "tedTarget shiftKey target timeStamp view which"
            ).split(" "),
            fixHooks: {},
            keyHooks: {
                ...
                return ka.test(this.nodeName)
                    ...
                    : void n
                        ...
                        .add(this, "beforeactivate._change", function (a) {
                            var b = a.target;
                            ka.test(b.nodeName) && !n._data(b, "change") && (
        ...
        l.focusin || n.each({
            ...
            var c = function (a) {
                n
                    .event
                    .simulate(b, a.target, n.event.fix(a))
            };
            n
                .event
                .special[b] = {
            ...
            if (o && (
                ...
                if (h) 
                    for (j = i[i.length - 1].ownerDocument, n.map(i, Ea), m = 0; h > m; m++) 
                        g = i[m],
                        _.test(g.type || "") && !n._data(g, "globalEval") && n.contains(j, g) && (
                            g.src
                ...
                text: function (a) {
                    return Y(this, function (a) {
                        return void 0 === a
                            ...
                            : this
                                .empty()
                                .append((this[0] && this[0].ownerDocument || d).createTextNode(a))
        ...
        !function () {
            ...
            if (j.style) {
                ...
                i = d.createElement("div"),
                i.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;positi" +
                        "on:absolute",
                j.innerHTML = "",
                i.appendChild(j),
                ...
                function k() {
                    var k,
                        ...
                        m = d.documentElement;
                    m.appendChild(i),
                    j.style.cssText = "-webkit-box-sizing:border-box;box-sizing:border-box;position:relative;display:" +
                            "block;margin:auto;border:1px;padding:1px;top:1%;width:50%",
                    b = e = h = !1,
                    c = g = !0,
                    a.getComputedStyle && (
                        ...
                        k.style.cssText = j.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-" +
        ...
        n
            ...
            .extend(
                ...
                var Gb = /#.*$/, Hb = /([?&])_=[^&]*/, Ib = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Jb = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Kb = /^(?:GET|HEAD)$/, Lb = /^\/\//, Mb = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Nb = {}, Ob = {}, Pb = "*/".concat(
                        "*"
                    ...
                    ajax: function (b, c) {
                        ...
                        if (
                            ...
                            null == l.crossDomain && (
                                ...
                                l.crossDomain = !(!d || d[1] === Rb[1] && d[2] === Rb[2] && (d[3] || (
                                    "http:" === d[1]
                                        ? "80"
                                        : "443"
                                )) === (Rb[3] || (
                        ...
                        (l.data && l.hasContent && l.contentType !== !1 || c.contentType) && w.setRequestHeader(
                            "Content-Type",
                            l.contentType
                        ),
                        w.setRequestHeader(
                ...
                n.expr.filters.hidden = function (a) {
                    return l.reliableHiddenOffsets()
                        ? a.offsetWidth <= 0 && a.offsetHeight <= 0 && !a
                            .getClientRects()
                            .length
                        : Yb(a)
                ...
                return d
                    ...
                    serializeArray: function () {
                        return this
                            ...
                            .filter(function () {
                                var a = this.type;
                                return this.name && !n(this).is(":disabled") && bc.test(this.nodeName) && !ac.test(
                                    a
                ...
                a.attachEvent && a.attachEvent("onunload", function () {
                    for (var a in ec) 
                        ec[a](void 0, !0)
                }), l.cors = !!fc && "withCredentials" in fc, fc = l.ajax = !!fc, fc && n.ajaxTransport(
                    function (b) {
